...
import com.jskj.springboot.exception.WithTypeException;
...
public class Exception2CodeRepo {
	...
	private static final ImmutableMap<Object, RestCode> MAP = ImmutableMap.<Object, RestCode>builder()
	        ...
	        .put(UserException.Type.USER_AUTH_FAIL,RestCode.USER_AUTH_FAIL)
	        .put(UserException.Type.USER_ALREADY_EXIt,RestCode.USER_ALREADY_EXIt).build();
